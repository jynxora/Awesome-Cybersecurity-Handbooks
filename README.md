...
> [!NOTE]
> As always, it is pretty hard to point out each and every source for different tools or payloads. If I used 'your' payload anywhere in my notes and you want to be mentioned or credited for the same, feel free to reach out to me on [X](https://twitter.com/syr0_) — or preferably [Bluesky](https://bsky.app/profile/0xsyr0.bsky.social) — and I will add you asap.
